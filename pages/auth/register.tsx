...
export default function RegisterPage() {
  ...
  const {
    ...
    defaultValues: {
      role: "STUDENT",
      // Admins can share a prefilled link: /auth/register?school=<code>
      schoolCode: typeof router.query.school === "string" ? router.query.school : "",
    },
  });
        ...
        <form onSubmit={submit} className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              placeholder="Ask your school admin for this"
              {...register("schoolCode")}
            />
            {errors.schoolCode && <p className="mt-1 text-xs text-red-600">{errors.schoolCode.message}</p>}
          </div>
