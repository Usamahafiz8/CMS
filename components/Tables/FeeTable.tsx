        ...
        <table className="min-w-full divide-y divide-slate-200 text-sm">
          <thead className="bg-slate-50">
            <tr>
              ...
              <th className="px-4 py-2.5 text-left font-semibold text-slate-600">Amount</th>
              <th className="px-4 py-2.5 text-left font-semibold text-slate-600">Due Date</th>
          ...
          <tbody className="divide-y divide-slate-100 bg-white">
            {fees.map((fee) => (
              <tr key={fee.id} className="transition-colors hover:bg-slate-50">
                ...
                <td className="px-4 py-2.5 text-slate-600">{fee.feeType}</td>
                <td className="px-4 py-2.5 text-slate-600">{formatCurrency(fee.amount)}</td>
                <td className="px-4 py-2.5 text-slate-600">{new Date(fee.dueDate).toLocaleDateString()}</td>
