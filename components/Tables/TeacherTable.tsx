        ...
        <table className="min-w-full divide-y divide-slate-200 text-sm">
          <thead className="bg-slate-50">
            <tr>
              ...
              <th className="px-4 py-2.5 text-left font-semibold text-slate-600">Employee ID</th>
          ...
          <tbody className="divide-y divide-slate-100 bg-white">
            {teachers.map((teacher) => (
              <tr key={teacher.id} className="transition-colors hover:bg-slate-50">
                ...
                <td className="px-4 py-2.5 text-slate-600">{teacher.employeeId}</td>
                <td className="px-4 py-2.5 text-slate-600">{teacher.phone ?? "—"}</td>
