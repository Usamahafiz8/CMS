      ...
      <table className="min-w-full divide-y divide-slate-200 text-sm">
        <thead className="bg-slate-50">
          <tr>
            ...
            <th className="px-4 py-3 text-left font-semibold text-slate-600">Marks</th>
            ...
            <th className="px-4 py-3 text-left font-semibold text-slate-600">Published</th>
          </tr>
        </thead>
        <tbody className="divide-y divide-slate-100 bg-white">
          {marks.map((mark) => (
            <tr key={mark.id} className="transition-colors hover:bg-slate-50">
              ...
              <td className="px-4 py-3 text-slate-600">{mark.subject.name}</td>
              <td className="px-4 py-3 text-slate-600">
                {mark.marks} / {mark.totalMarks}
              </td>
              <td className="px-4 py-3 text-slate-600">{mark.percentage}%</td>
              <td className="px-4 py-3 font-semibold text-slate-700">{mark.grade}</td>
